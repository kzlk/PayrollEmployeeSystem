...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_EmployeeInfo_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_EmployeeInfo_t qt_meta_stringdata_EmployeeInfo = {
    {
QT_MOC_LITERAL(0, 12), // "EmployeeInfo"
QT_MOC_LITERAL(13, 21), // "on_pushButton_clicked"
QT_MOC_LITERAL(35, 0) // ""

    },
    "EmployeeInfo\0on_pushButton_clicked\0"
};
...
void EmployeeInfo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<EmployeeInfo *>(_o);
        (void)_t;
        switch (_id) {
...
const QMetaObject EmployeeInfo::staticMetaObject = { {
    ...
    qt_meta_stringdata_EmployeeInfo.offsetsAndSize,
    qt_meta_data_EmployeeInfo,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_EmployeeInfo_t
, QtPrivate::TypeAndForceComplete<EmployeeInfo, std::true_type>
